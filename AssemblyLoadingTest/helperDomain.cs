...
namespace AssemblyLoadingTest
{
    ...
    class helperDomain<T> : MarshalByRefObject where T : class
    {
        ...
        #region .ctor
        public helperDomain(string AssemblyFile, string domainName,
           string configFile = null)
        {
            ...
            try
            {
                ...
                var domainNameREAL = domainName.Split('.')[0];
                this._assembly_class_name = $"{domainNameREAL}.{domainNameREAL}Invoker";
